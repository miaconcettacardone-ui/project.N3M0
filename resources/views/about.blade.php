...
<section class="section"><div class="container team-section"><p class="section-label">Our Team</p><h2 class="section-title" style="text-align:center">The People Behind NEMO</h2><p class="section-subtitle" style="margin:0 auto 2rem;text-align:center;">Placeholder — add your real team members here later.</p><div class="team-grid"><div class="team-card"><div class="team-photo">&#128100;</div><div class="team-info"><h4>Your Name</h4><p>Founder & Lead Writer</p></div></div><div class="team-card"><div class="team-photo">&#128100;</div><div class="team-info"><h4>Team Member</h4><p>Research & Content</p></div></div><div class="team-card"><div class="team-photo">&#128100;</div><div class="team-info"><h4>Team Member</h4><p>Design & Media</p></div></div></div></div></section>
@endsection
